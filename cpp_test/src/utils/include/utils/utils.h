 ...
 * 不接受 id != 0 的 info, 具体给每个方法的测试输入自己给就行, 函数的输入由 info.mess 给出(对于 sortString() 函数
 * vec可以给出由 , 作为分隔符传递(如: "asfg,asgq,aspgfino")再通过splitString分割, type 可以由 0 代表升序, 1 代表降序) \n
